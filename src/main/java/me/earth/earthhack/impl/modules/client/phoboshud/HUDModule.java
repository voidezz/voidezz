...
import me.earth.earthhack.impl.core.mixins.IMinecraft;
import me.earth.earthhack.impl.event.events.misc.UpdateEvent;
import me.earth.earthhack.impl.event.events.render.Render2DEvent;
import me.earth.earthhack.impl.managers.Managers;
import me.earth.earthhack.impl.modules.Caches;
import me.earth.earthhack.impl.modules.client.hud.modes.HudRainbow;
import me.earth.earthhack.impl.modules.client.phoboshud.enums.LagNotifyEnum;
import me.earth.earthhack.impl.modules.client.phoboshud.enums.WaterMarkEnum;
...
import me.earth.earthhack.impl.modules.client.phoboshud.enums.GreeterEnum;
...
public class HUDModule extends Module
{
    ...
    private final Setting<WaterMarkEnum> watermark = register(new EnumSetting<>("Logo", WaterMarkEnum.NONE));
    ...
    private final Setting<GreeterEnum> greeter = register(new EnumSetting<>("Greeter", GreeterEnum.NONE));
    ...
    private final Setting<LagNotifyEnum> lag = register(new EnumSetting<>("Lag", LagNotifyEnum.GRAY));
    ...
    public HUDModule() {
        super("PhobosHud", Category.Client);
        this.setData(new SimpleData(this, "The Phobos-HUD plugin originally from Phobos, then made into a plugin for 3arthh4ck, and now patched here by dyl#0013"));
        setInstance();
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        switch (watermark.getValue()) {
            ...
            case EARTH:
                ...
                break;
            case CHRISTMASCC:
                renderText("christmas.cc" + (modeVer.getValue() ? " " + Earthhack.VERSION : ""), 2, 2);
                break;
            case CHRISTMASCCPLUS:
                renderText("christmas.cc+" + (modeVer.getValue() ? " " + Earthhack.VERSION : ""), 2, 2);
                break;
            case CUSTOM:
        ...
        if (greeter.getValue() != GreeterEnum.NONE) {
            renderGreeter();
        }

        if (lag.getValue() != LagNotifyEnum.NONE) {
            renderLag();
        }
    ...
    public void renderGreeter() {
        ...
        switch (greeter.getValue()) {
            ...
            case LONG:
                ...
                break;
            case BASED:
                text += "Hey, " + mc.player.getDisplayNameString() + " you are based!";
                break;
            case SNOW:
                text += "Welcome " + mc.player.getDisplayNameString() + " AAAA";
                break;
            case CHRISTMASCC:
                text += "Welcome to christmas.cc " + mc.player.getDisplayNameString() + ", you will win!";
                break;
            case CHRISTMASCCPLUS:
                text += "Welcome to christmas.cc+ " + mc.player.getDisplayNameString() + ", you lookin' cute today";
                break;
            case TRANS:
                text += TextColor.AQUA + "t" + TextColor.LIGHT_PURPLE + "r" + TextColor.WHITE + "a" + TextColor.LIGHT_PURPLE + "n" + TextColor.AQUA + "s";
                break;
            case CUSTOM:
    ...
    public void renderLag() {
        ...
        if (Managers.SERVER.lastResponse() > 1500) {
            String text = (lag.getValue() == LagNotifyEnum.GRAY ? TextColor.GRAY : TextColor.RED) + "Server not responding: " + MathUtil.round((Managers.SERVER.lastResponse() / 1000.0f), 1) + "s.";
