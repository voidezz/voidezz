...
public class ThreadHelper implements Globals
{
    ...
    private volatile CalculationMotion currentCalc;
    ...
    public synchronized void start(CalculationMotion calculation,
                                   boolean multiThread)
    {
    ...
    private void startThread(List<Entity> entities,
                             ...
                             BlockPos...blackList)
    {
        currentCalc = new CalculationMotion(module, entities, players);
    ...
    private void execute(CalculationMotion calculation,
                         boolean multiThread)
    {
        if (multiThread)
        {
