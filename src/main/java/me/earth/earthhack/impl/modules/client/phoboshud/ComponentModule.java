...
import me.earth.earthhack.impl.core.mixins.IRenderGlobal;
...
import static me.earth.earthhack.impl.modules.client.phoboshud.HUDModule.drawLine;
...
public class ComponentModule extends Module
{
    ...
    public void drawCompass() {
        ...
        if(compass.getValue() == Compass.LINE) {
            ...
            drawLine(compassX.getValue() - rotationYaw + (100 / 2) + zeroZeroYaw, compassY.getValue() + 2, compassX.getValue() - rotationYaw + (100 / 2) + zeroZeroYaw, compassY.getValue() + Managers.TEXT.getStringHeight() - 2, 2, 0xFFFF1010);
            drawLine((compassX.getValue() - rotationYaw + (100 / 2)) + 45, compassY.getValue() + 2, (compassX.getValue() - rotationYaw + (100 / 2)) + 45, compassY.getValue() + Managers.TEXT.getStringHeight() - 2, 2, 0xFFFFFFFF);
            drawLine((compassX.getValue() - rotationYaw + (100 / 2)) - 45, compassY.getValue() + 2, (compassX.getValue() - rotationYaw + (100 / 2)) - 45, compassY.getValue() + Managers.TEXT.getStringHeight() - 2, 2, 0xFFFFFFFF);
            drawLine((compassX.getValue() - rotationYaw + (100 / 2)) + 135, compassY.getValue() + 2, (compassX.getValue() - rotationYaw + (100 / 2)) + 135, compassY.getValue() + Managers.TEXT.getStringHeight() - 2, 2, 0xFFFFFFFF);
            drawLine((compassX.getValue() - rotationYaw + (100 / 2)) - 135, compassY.getValue() + 2, (compassX.getValue() - rotationYaw + (100 / 2)) - 135, compassY.getValue() + Managers.TEXT.getStringHeight() - 2, 2, 0xFFFFFFFF);
