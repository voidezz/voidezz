...
final class TpsSyncData extends DefaultData<TpsSync>
{
    ...
    {
        return "Syncs your actions with the servers tps. This module helps with SilentSwitch AutoCrystal configs. Also should fix the 'Block break not in sync!' Server kick.";
    }
