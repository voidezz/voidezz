...
import me.earth.earthhack.impl.modules.chat.antilinks.AntiLinks;
...
import me.earth.earthhack.impl.modules.chat.notifications.Notifications;
...
import me.earth.earthhack.impl.modules.chat.antipoplag.AntiPopLag;
...
import me.earth.earthhack.impl.modules.chat.announcer.Announcer;
import me.earth.earthhack.impl.modules.misc.antiaim.AntiAim;
import me.earth.earthhack.impl.modules.chat.antiopp.AntiOpp;
...
import me.earth.earthhack.impl.modules.chat.antivanish.AntiVanish;
...
import me.earth.earthhack.impl.modules.chat.chat.Chat;
...
import me.earth.earthhack.impl.modules.chat.log.Log;
...
import me.earth.earthhack.impl.modules.chat.spammer.Spammer;
import me.earth.earthhack.impl.modules.chat.suffix.Suffix;
...
public class ModuleManager extends IterationRegister<Module>
{
    public void init()
    {
        ...
        this.forceRegister(new HUDModule());
        ...
        this.forceRegister(new AntiLinks());
        this.forceRegister(new AntiOpp());
        this.forceRegister(new AntiPopLag());
        this.forceRegister(new AntiVanish());
        this.forceRegister(new Chat());
        this.forceRegister(new Log());
